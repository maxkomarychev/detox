describe('expect', () => {
  ...
  it(`element by accessibilityLabel`, async () => {
    await e.expect(e.element(e.by.accessibilityLabel('test'))).toBeVisibleMinPercent(0.3);
  ...
  it(`element by label (for backwards compat)`, async () => {
    await e.expect(e.element(e.by.label('test'))).toBeVisibleMinPercent(0.3);
  ...
  it(`waitFor (element)`, async () => {
    ...
    await e.waitFor(e.element(e.by.id('id'))).toBeVisibleMinPercent(0.3);
